          ...
          <div key={yarn.id} className="card p-4">
            <div className="flex items-start justify-between gap-2">
              <button className="text-left flex-1" onClick={() => openEdit(yarn)}>
                <p className="section-title text-lg">{yarn.name}</p>
            ...
            {low && (
              <div className="flex items-center gap-1.5 mt-2 bg-burgundy-100 text-burgundy-600 text-xs font-medium px-2.5 py-1.5 rounded-lg">
        ...
        <div className="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50">
          <div className="card p-5 w-full sm:max-w-sm max-h-[85vh] overflow-y-auto rounded-b-none sm:rounded-b-xl2">
            <div className="flex items-center justify-between mb-3">
              <p className="section-title text-lg">Пряжа</p>
